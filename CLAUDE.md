...
A personal retirement asset-planning app where users track assets, liabilities, nominees, and country locations — with an AI-generated beneficiary access guide — demoable without login.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "295331568+tian2bang@users.noreply.github.com"
  git config user.name "tian2bang"
  ```
